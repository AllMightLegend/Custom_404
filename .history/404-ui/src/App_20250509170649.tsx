...
const RAW_BOXES_404 = [
  // --- 4 ---
  { x: 0, y: 66, },
  { x: 86, y: 0, }, { x: 56, y: 22,  }, { x: 36, y: 66, },
  { x: 72, y: 66,  },{ x: 24, y: 44,  },
  { x: 108, y: 0, }, { x: 108, y: 22,  }, { x: 108, y: 44, }, { x: 108, y: 66, }, { x: 108, y: 88,  },{ x: 108, y: 110,  },
  // --- 0 ---
  { x: 256, y: 0,  }, { x: 292, y: 0,  },
  { x: 230, y: 11,  }, { x: 318, y: 11,  }, 
  { x: 215, y: 22, }, { x: 333, y: 22, },
  { x: 205, y: 44,  }, { x: 343, y: 44,  },
  { x: 205, y: 66, }, { x: 343, y: 66,  },
  { x: 215, y: 88,  }, { x: 333, y: 88,  },
  { x: 230, y: 99,  }, { x: 318, y: 99,  },
  { x: 292, y: 110, },{ x: 256, y: 110,  }, 
  // --- 4 ---
  { x: 526, y: 0, }, { x: 496, y: 22,  }, { x: 464, y: 44, },{ x: 440, y: 66, },
  { x: 476, y: 66,  },
  { x: 512, y: 66,  },
  { x: 548, y: 0, }, { x: 548, y: 22,  }, { x: 548, y: 44, }, { x: 548, y: 66, }, { x: 548, y: 88,  },{ x: 548, y: 110,  },
];
...
function App() {
  ...
  useEffect(() => {
    ...
    const shuffledImages = [...DRIBBBLE_IMAGES].sort(() => Math.random() - 0.5);
    setImages(shuffledImages);
  }, [hue]); // Re-shuffle images when hue changes
  ...
  return (
    <div className="notfound-bg">
          ...
          return (
            <motion.div
              ...
              style={{
                ...
                width: BOX_W,
                height: BOX_H,
                zIndex: i === 0 ? 1 : 2 + (i % 8), // Ensure the first box is behind others
      ...
      <div className="notfound-slider-wrap" style={{ marginTop: 80 }}>
        <input
          type="range"
          min={0}
          max={360}
